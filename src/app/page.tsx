...
/**
 * @fileoverview Enhanced Landing page for Skience with Interactive Mouse Wiggle.
 * 
 * Features:
 * - Interactive 3D tilt and parallax "wiggle" that follows the mouse cursor.
...
export default function Home() {
  ...
  // Rotation transforms for 3D tilt
  const rotateX = useTransform(springY, [-0.5, 0.5], [10, -10]);
  const rotateY = useTransform(springX, [-0.5, 0.5], [-10, 10]);

  // Parallax offsets (Wiggle towards mouse)
  // When mouse is at 0.5 (right), title moves 20px (right)
  ...
  return (
    <div 
      ...
      className="flex flex-col min-h-screen bg-background text-foreground select-none relative overflow-hidden"
    >
      ...
      >
        ...
        >
          ...
          <motion.p 
            ...
            className="max-w-2xl text-muted-foreground text-lg mb-10 font-body leading-relaxed"
          >
