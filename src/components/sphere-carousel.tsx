 ...
 * - Glow contained strictly within card boundaries using overflow clipping.
  ...
  return (
    <div className="relative w-full h-full group">
      ...
      >
        ...
        <CardContent className="flex flex-col items-center gap-3 px-6 md:px-10 pb-8 relative z-30">
          <Button
            asChild
            variant="outline"
            size="sm"
            className={cn(
              "w-full h-11 btn-hover-pop bg-white/5 border-white/10 hover:bg-white/10 rounded-2xl transition-all font-body tracking-wide",
